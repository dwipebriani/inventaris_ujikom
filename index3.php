...
ob_start();
session_start();
if(!isset($_SESSION['pegawai_id'])) header("location:login_pegawai.php");
include "config.php";
 ?> 
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
  <!--   <ul class="sidebar navbar-nav bg-success " style="width: 100px;"> -->
                ...
                <tbody>
                  ...
                  $no=1;  
                   ...
                   ?>
                      ...
                      <td><a class="btn btn-danger" href="prosestampilan/pinjam.php?kode=<?= $data['kode']; ?>"><i class="fa fa-cart-plus"></i></a> </td> 
