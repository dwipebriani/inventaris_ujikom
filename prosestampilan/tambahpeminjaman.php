...
<div class="col-xs-12 col-md-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="jumlah_pinjam[]" required="" placeholder="Masukan Jumlah Pinjam" type="number">
        			...
        			<div class="form-group">
        				<input class="form-control" type="hidden" name="status_peminjaman[]" value="proses" required="">
        			</div>
                <div class="form-group">
                <input class="form-control" type="hidden" value="<?=$_SESSION['pegawai_id'] ?>" name="id_pegawai[]" required="">
              </div>
               <td> 
