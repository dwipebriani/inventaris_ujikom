    ...
    <ul class="sidebar navbar-nav " style="width: 100px;">
      ...
      <li class="nav-item active">
       ...
       <p class="centered mt-2" style="text-align: center;">
          <img width="90" height="100" class="rounded-circle mt-2" src="http://localhost/inventarisdwi/gambar/<?php echo $_SESSION['petugas_foto']; ?>"  >
       </p>
     ...
     ?>
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="datapegawai.php">Pegawai</a>
